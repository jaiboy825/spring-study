<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<!-- Brand Logo -->
	<a href="${path}/article/paging/search/list" class="brand-link"> <img
		src="${path}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
		class="brand-image img-circle elevation-3" style="opacity: .8"> <span
		class="brand-text font-weight-light">Jaiboy's Board</span>
	</a>
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<c:if test="${empty login}">
				<div class="image">
					<img src="${path}/dist/img/default-user.png"
			...
			<c:if test="${not empty login}">
				<div class="image">
					<img src="${path}/dist/img/user/${login.userImg}"
						class="img-circle elevation-2" alt="User Image">
				</div>
				<div class="info">
					<%-- Status --%>
               ...
               with font-awesome or any other icon font library -->
				<li class="nav-item has-treeview menu-open"><a href="#"
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="${path}/article/write" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Write Page</p>
						</a></li>
						<li class="nav-item"><a href="${path}/article/list" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>List Page</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item has-treeview menu-open"><a href="#"
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="${path}/article/paging/search/write"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Write Page</p>
						</a></li>
						<li class="nav-item"><a href="${path}/article/paging/search/list"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>List Page</p>
						</a></li>
					</ul></li>
