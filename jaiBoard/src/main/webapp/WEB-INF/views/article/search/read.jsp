...
<body class="hold-transition sidebar-mini">
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body" style="height: 700px">${article.content}
								<div class="box-footer uploadedList"></div>
							</div>
							<div class="card-footer">
								<div class="user-block">
									...
									</span> <span class="description"><fmt:formatDate pattern="yyyy-MM-dd"
    ...
    $(document).ready(function() {
      ...
      var templatePhotoAttach = Handlebars.compile($("#templatePhotoFile").html());
      ...
      $.getJSON("/file/list/" + article_no, function(list) {
        $(list).each(function() {
          ...
          if (fileInfo.fullName.substr(12, 2) == "s_") {
            html = templatePhotoAttach(fileInfo);
          } else {
